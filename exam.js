// ============================================================
// EXAM.JS - COMPLETE UPDATED FOR NEW HTML STRUCTURE
...
(function() {
    ...
    function initDomRefs() {
        ...
        DOM.stepContent1 = document.getElementById('stepContent1');
        DOM.stepContent2 = document.getElementById('stepContent2');
        DOM.stepContent3 = document.getElementById('stepContent3');
    }
    ...
    function toggleTermsAgreed() {
        ...
        if (DOM.termsNextBtn.disabled) {
            DOM.termsNextBtn.style.opacity = '0.4';
    ...
    function updateStartButton() {
        ...
        if (DOM.startExamBtn.disabled) {
            DOM.startExamBtn.style.opacity = '0.4';
    ...
    async function testCamera() {
        ...
        try {
            ...
            if (faceDetected) {
                ...
                DOM.cameraNextBtn.style.opacity = '0.4';
    ...
    // ============================================================
    // EXECUTE SUBMISSION (Simplified for brevity)
    // ============================================================
        ...
        DOM.examContainer.innerHTML = `
            <div style="text-align:center; padding:30px 20px;">
                ...
                <div style="background:linear-gradient(135deg, #f0fdf4, #ecfdf5); border-radius:14px; padding:20px; max-width:500px; margin:12px auto; border:1px solid #86efac;">
                    ...
                    <p style="color:#64748b; font-size:0.85rem; margin-top:12px;">Your results will be available after review.</p>
                </div>
    ...
    // ============================================================
    // FULLSCREEN & SECURITY (Simplified)
    // ============================================================
    ...
    function handleBeforeUnload(e) {
        if (AppState.isExamActive && !AppState.isSubmitting) {
            e.preventDefault();
            e.returnValue = '⚠️ EXAM IN PROGRESS! Your progress will be saved.';
            return '⚠️ EXAM IN PROGRESS! Your progress will be saved.';
        }
    }
    ...
    // ============================================================
    // SECURE FACE PROCTOR CLASS (Minimal)
    // ============================================================
...
console.log('📋 Available functions: renderQuestion, prevQuestion, nextQuestion, submitExam, toggleReviewMode, toggleFlagQuestion, returnToExam, closeAttendanceModal, retryCameraDuringExam, goToStep, toggleTermsAgreed, testCamera, startExam, showToast');
