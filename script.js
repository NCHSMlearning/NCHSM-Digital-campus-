 ...
 * ✅ ALL functions protected with 'if' guards
 * ✅ No duplicate errors
 * ✅ Safe to load even if functions exist elsewhere
 *******************************************************/

// ============================================
// 📊 STATE - Only declare if not exists
// ============================================
if (typeof USERS_STATE === 'undefined') {
    const USERS_STATE = {
        page: 1,
        perPage: 20,
        total: 0,
...
// ============================================================
// 🔥 HELPER: Escape HTML (only if not already defined)
// ============================================================
...
// ============================================================
// 🔥 PROGRAM HELPER FUNCTIONS - Only if not already defined
// ============================================================
...
if (typeof getProgramLevel === 'undefined') {
    function getProgramLevel(programCode) {
        if (!programCode) return 'N/A';
...
if (typeof getDisplayIntake === 'undefined') {
...
// ============================================================
// 🔥 POPULATE PROGRAM AND BLOCK DROPDOWNS IN MANAGE USERS
// ============================================================

if (typeof populateUserProgramFilter === 'undefined') {
    async function populateUserProgramFilter() {
        ...
        try {
            ...
            uniquePrograms.forEach(program => {
                const displayName = typeof getProgramDisplayName === 'function' ? 
...
if (typeof populateUserBlockFilter === 'undefined') {
...
if (typeof updateBlockTermOptions === 'undefined') {
    function updateBlockTermOptions(programSelectId, blockSelectId) {
        ...
        const isTVET = typeof isTVETProgram === 'function' ? 
...
if (typeof populateUserFilterDropdownsIfEmpty === 'undefined') {
...
if (typeof sendApprovalEmail === 'undefined') {
    async function sendApprovalEmail(email, userName, role, program, intakeYear, block) {
        ...
        const programDisplay = typeof getProgramDisplayName === 'function' ? 
            getProgramDisplayName(program) : (program || 'N/A');
        const programType = typeof getProgramType === 'function' ? 
            getProgramType(program) : 'KRCHN';
        const programLevel = typeof getProgramLevel === 'function' ? 
            getProgramLevel(program) : 'N/A';
        const blockLabel = programType === 'TVET' ? 'Term' : 'Block';
        const blockDisplay = block || 'Not assigned';
        const intakeDisplay = intakeYear ? (typeof getDisplayIntake === 'function' ? getDisplayIntake(program, intakeYear) : intakeYear) : 'N/A';
        
        try {
            const year = new Date().getFullYear();
            const roleDisplay = role === 'student' ? 'Student' : role || 'User';
            
            // Simplified email - just use fallback to avoid errors
...
if (typeof sendApprovalEmailFallback === 'undefined') {
...
if (typeof loadAllUsers === 'undefined') {
...
if (typeof renderUsersTable === 'undefined') {
    function renderUsersTable(users, docCache = {}) {
        ...
        for (const u of users) {
            ...
            const programName = typeof getProgramDisplayName === 'function' ? 
                getProgramDisplayName(u.program) : (u.program || 'N/A');
            const programType = typeof getProgramType === 'function' ? 
                getProgramType(u.program) : 'KRCHN';
            ...
            const intakeDisplay = u.intake_year ? (typeof getDisplayIntake === 'function' ? getDisplayIntake(u.program, u.intake_year) : u.intake_year) : 'N/A';
...
if (typeof updateUserStats === 'undefined') {
...
if (typeof renderUserPagination === 'undefined') {
...
if (typeof changeUserPage === 'undefined') {
...
if (typeof searchUsersDebounced === 'undefined') {
...
if (typeof resetUserFilters === 'undefined') {
...
if (typeof loadFilterOptions === 'undefined') {
        ...
        try {
            ...
            if (programFilter) {
                ...
                const sortedPrograms = [...USERS_STATE.cache.programs].sort((a, b) => {
                    const nameA = typeof getProgramDisplayName === 'function' ? 
                        getProgramDisplayName(a) : a;
                    const nameB = typeof getProgramDisplayName === 'function' ? 
                        getProgramDisplayName(b) : b;
                    return nameA.localeCompare(nameB);
                });
                sortedPrograms.forEach(p => {
                    const displayName = typeof getProgramDisplayName === 'function' ? 
                        getProgramDisplayName(p) : p;
...
if (typeof loadPendingApprovals === 'undefined') {
    async function loadPendingApprovals() {
        ...
        try {
            ...
            for (const u of pending) {
                ...
                if (u.role === 'student') {
                    const programName = typeof getProgramDisplayName === 'function' ? 
                        getProgramDisplayName(u.program) : (u.program || 'Not set');
                    const programType = typeof getProgramType === 'function' ? 
                        getProgramType(u.program) : 'KRCHN';
                ...
                if (u.role === 'student' && u.intake_year) {
                    intakeDisplay = typeof getDisplayIntake === 'function' ? 
                        getDisplayIntake(u.program, u.intake_year) : u.intake_year;
                } else if (u.role === 'lecturer') {
    ...
    async function loadStudents() {
        ...
        try {
            ...
            students.forEach((student, index) => {
                const programName = typeof getProgramDisplayName === 'function' ? 
                    getProgramDisplayName(student.program) : (student.program || 'N/A');
                const programType = typeof getProgramType === 'function' ? 
                    getProgramType(student.program) : 'KRCHN';
                ...
                const intakeDisplay = student.intake_year ? (typeof getDisplayIntake === 'function' ? getDisplayIntake(student.program, student.intake_year) : student.intake_year) : 'N/A';
...
if (typeof initManageUsers === 'undefined') {
...
if (typeof openDocumentUploadModal === 'undefined') {
...
if (typeof uploadUserDocuments === 'undefined') {
    async function uploadUserDocuments() {
        ...
        if (typeof showLoading === 'function') showLoading('Uploading documents...');
...
if (typeof viewDocument === 'undefined') {
...
if (typeof handleAddAccount === 'undefined') {
    async function handleAddAccount(e) {
        ...
        const programType = typeof getProgramType === 'function' ? getProgramType(programCode) : 'KRCHN';
        const programName = typeof getProgramDisplayName === 'function' ? getProgramDisplayName(programCode) : programCode;
        const programLevel = typeof getProgramLevel === 'function' ? getProgramLevel(programCode) : 'N/A';
...
if (typeof handleMassPromotion === 'undefined') {
    async function handleMassPromotion(e) {
        ...
        const programName = typeof getProgramDisplayName === 'function' ? getProgramDisplayName(promote_program) : promote_program;
        const programType = typeof getProgramType === 'function' ? getProgramType(promote_program) : 'KRCHN';
        const blockLabel = programType === 'TVET' ? 'Term' : 'Block';
...
if (typeof approveUser === 'undefined') {
...
if (typeof showApprovalModal === 'undefined') {
    function showApprovalModal(user) {
        ...
        const programType = typeof getProgramType === 'function' ? getProgramType(user.program) : 'KRCHN';
        const isTVET = programType === 'TVET';
        const isStudent = user.role === 'student';
        const isLecturer = user.role === 'lecturer';
        
        // Complete program options dropdown - simplified for brevity
        ...
        if (programSelect && programTypeInput) {
            programSelect.addEventListener('change', function() {
                ...
                const newType = typeof getProgramType === 'function' ? getProgramType(selectedProgram) : 'KRCHN';
                programTypeInput.value = newType;
                if (typeof updateBlockOptions === 'function') {
        ...
        if (roleSelect) {
            roleSelect.addEventListener('change', function() {
                ...
                const programTypeField = document.getElementById('program_type_field');
                const intakeField = document.getElementById('intake_field');
                ...
                const employmentField = document.getElementById('employment_field');
                
                if (programField) programField.style.display = isStudentRole ? 'block' : 'none';
                if (programTypeField) programTypeField.style.display = isStudentRole ? 'block' : 'none';
                if (intakeField) intakeField.style.display = isStudentRole ? 'block' : 'none';
                if (blockField) blockField.style.display = isStudentRole ? 'block' : 'none';
                if (departmentField) departmentField.style.display = isLecturerRole ? 'block' : 'none';
                if (staffIdField) staffIdField.style.display = isLecturerRole ? 'block' : 'none';
                if (employmentField) employmentField.style.display = isLecturerRole ? 'block' : 'none';
                
                const programSelect = document.getElementById('edit_program');
                const departmentSelect = document.getElementById('edit_department');
                if (programSelect) programSelect.required = isStudentRole;
                if (departmentSelect) departmentSelect.required = isLecturerRole;
                
                const studentIdField = document.getElementById('edit_student_id');
                if (studentIdField) {
                    const parent = studentIdField.closest('.form-group');
                    if (parent) {
                        parent.style.display = (isStudentRole || isLecturerRole) ? 'block' : 'none';
                    }
                }
            });
        }
...
if (typeof updateBlockOptions === 'undefined') {
...
if (typeof closeApprovalModal === 'undefined') {
...
if (typeof confirmApproveUser === 'undefined') {
    async function confirmApproveUser() {
        ...
        if (!fullName) {
            if (typeof showFeedback === 'function') showFeedback('❌ Full Name is required', 'error');
            return;
        }
        if (!email) {
            if (typeof showFeedback === 'function') showFeedback('❌ Email is required', 'error');
            return;
        }
        
        if (role === 'student' && !program) {
            if (typeof showFeedback === 'function') showFeedback('❌ Program is required for students', 'error');
            return;
        }
        
        if (role === 'lecturer' && !department) {
            if (typeof showFeedback === 'function') showFeedback('❌ Department is required for lecturers', 'error');
            return;
        }
...
if (typeof updateUserRole === 'undefined') {
...
if (typeof deleteProfile === 'undefined') {
...
if (typeof openEditUserModal === 'undefined') {
    async function openEditUserModal(userId) {
        try {
            ...
            if (editUserProgram) {
                ...
                const isTVET = typeof isTVETProgram === 'function' ? isTVETProgram(user.program) : false;
                if (blockLabel) {
                ...
                setTimeout(() => {
                    if (editUserBlock) {
                        if (typeof updateBlockTermOptions === 'function') {
...
if (typeof handleEditUser === 'undefined') {
    async function handleEditUser(e) {
        ...
        try {
            ...
            const isTVET = typeof isTVETProgram === 'function' ? isTVETProgram(program) : false;
...
if (typeof saveEditedUser === 'undefined') {
    const saveEditedUser = typeof handleEditUser !== 'undefined' ? handleEditUser : function() {
        console.warn('⚠️ handleEditUser not defined yet');
    };
}

// Close edit user modal
if (typeof closeEditUserModal === 'undefined') {
...
if (typeof filterPendingApprovals === 'undefined') {
...
if (typeof resetPendingFilters === 'undefined') {
    function resetPendingFilters() {
        ...
        if (typeof filterPendingApprovals === 'function') {
...
console.log('✅ All functions loaded successfully with duplicate protection!');
/*******************************************************
